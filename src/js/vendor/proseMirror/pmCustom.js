...
class $59526ec4d3b41406$var$ParseContext {
    ...
    readStyles(styles) {
        ...
        style: for(let i = 0; i < styles.length; i += 2)for(let after = undefined;;){
            ...
            if (rule.clearMark) this.top.pendingMarks.forEach((m)=>{
...
function $f18febfa986513b3$var$captureKeyDown(view, event) {
    ...
    else if (code == 46 || $f18febfa986513b3$var$mac && code == 68 && mods == "c") return $f18febfa986513b3$var$stopNativeHorizontalDelete(view, 1) || $f18febfa986513b3$var$skipIgnoredNodes(view, 1);
...
function $f18febfa986513b3$var$capturePaste(view, event) {
    ...
    setTimeout(()=>{
        ...
        if (plainText) $f18febfa986513b3$var$doPaste(view, target.value, null, view.input.shiftKey, event);
        else $f18febfa986513b3$var$doPaste(view, target.textContent, target.innerHTML, view.input.shiftKey, event);
    }, 50);
}
...
$f18febfa986513b3$var$editHandlers.paste = (view, _event)=>{
    ...
    let data = $f18febfa986513b3$var$brokenClipboardAPI ? null : event.clipboardData;
    if (data && $f18febfa986513b3$var$doPaste(view, data.getData("text/plain"), data.getData("text/html"), view.input.shiftKey, event)) event.preventDefault();
...
*/ function $1e062bab1b3a59ef$export$53f558754f8b9fd1(bindings) {
    ...
    return function(view, event) {
        let name = (0, $1c2882f00a2c3272$export$fb33aafd75404f4c)(event), baseName, direct = map[$1e062bab1b3a59ef$var$modifiers(name, event)];
        ...
        if (name.length == 1 && name != " ") {
            ...
            if ((event.shiftKey || event.altKey || event.metaKey || name.charCodeAt(0) > 127) && (baseName = (0, $1c2882f00a2c3272$export$e2253033e6e1df16)[event.keyCode]) && baseName != name) {
...
function $b26b082afa83b71a$export$2e2bcd8739ae039() {
    var elt = arguments[0];
    ...
    for(; i < arguments.length; i++)$b26b082afa83b71a$var$add(elt, arguments[i]);
    return elt;
}
function $b26b082afa83b71a$var$add(elt, child) {
    if (typeof child == "string") elt.appendChild(document.createTextNode(child));
    else if (child == null) ;
    else if (child.nodeType != null) elt.appendChild(child);
    else if (Array.isArray(child)) for(var i = 0; i < child.length; i++)$b26b082afa83b71a$var$add(elt, child[i]);
...
function $112cbd55c5be2ecc$var$getIcon(icon) {
    let node = document.createElement("div");
    ...
    if (icon.path) {
        ...
        if (!document.getElementById(name)) $112cbd55c5be2ecc$var$buildSVG(name, icon);
        let svg = node.appendChild(document.createElementNS($112cbd55c5be2ecc$var$SVG, "svg"));
        svg.style.width = width / height + "em";
        let use = svg.appendChild(document.createElementNS($112cbd55c5be2ecc$var$SVG, "use"));
        use.setAttributeNS($112cbd55c5be2ecc$var$XLINK, "href", /([^#]*)/.exec(document.location.toString())[1] + "#" + name);
...
function $112cbd55c5be2ecc$var$buildSVG(name, data) {
    let collection = document.getElementById($112cbd55c5be2ecc$var$prefix$2 + "-collection");
    if (!collection) {
        collection = document.createElementNS($112cbd55c5be2ecc$var$SVG, "svg");
        collection.id = $112cbd55c5be2ecc$var$prefix$2 + "-collection";
        collection.style.display = "none";
        document.body.insertBefore(collection, document.body.firstChild);
    }
    let sym = document.createElementNS($112cbd55c5be2ecc$var$SVG, "symbol");
    sym.id = name;
    sym.setAttribute("viewBox", "0 0 " + data.width + " " + data.height);
    let path = sym.appendChild(document.createElementNS($112cbd55c5be2ecc$var$SVG, "path"));
...
*/ class $112cbd55c5be2ecc$export$2ce376c2cc3355c8 {
    ...
    */ render(view) {
        let spec = this.spec;
        let dom = spec.render ? spec.render(view) : spec.icon ? $112cbd55c5be2ecc$var$getIcon(spec.icon) : spec.label ? (0, $b26b082afa83b71a$export$2e2bcd8739ae039)("div", null, $112cbd55c5be2ecc$var$translate(view, spec.label)) : null;
...
*/ class $112cbd55c5be2ecc$export$931cbfb6bfb85fc {
    ...
    */ render(view) {
        ...
        let label = (0, $b26b082afa83b71a$export$2e2bcd8739ae039)("div", {
        ...
        let wrap = (0, $b26b082afa83b71a$export$2e2bcd8739ae039)("div", {
    ...
    @internal
    */ expand(dom, items) {
        let menuDOM = (0, $b26b082afa83b71a$export$2e2bcd8739ae039)("div", {
...
function $112cbd55c5be2ecc$var$renderDropdownItems(items, view) {
    ...
    for(let i = 0; i < items.length; i++){
        ...
        rendered.push((0, $b26b082afa83b71a$export$2e2bcd8739ae039)("div", {
...
*/ class $112cbd55c5be2ecc$export$ef5c18bf09e4884f {
    ...
    */ render(view) {
        ...
        }, label, (0, $b26b082afa83b71a$export$2e2bcd8739ae039)("div", {
...
*/ function $112cbd55c5be2ecc$export$32280ef9552def7c(view, content) {
    ...
    for(let i = 0; i < content.length; i++){
        ...
        for(let j = 0; j < items.length; j++){
            ...
            let span = (0, $b26b082afa83b71a$export$2e2bcd8739ae039)("span", {
...
function $112cbd55c5be2ecc$var$separator() {
    return (0, $b26b082afa83b71a$export$2e2bcd8739ae039)("span", {
...
class $112cbd55c5be2ecc$var$MenuBarView {
    constructor(editorView, options){
        ...
        this.wrapper = (0, $b26b082afa83b71a$export$2e2bcd8739ae039)("div", {
            class: $112cbd55c5be2ecc$var$prefix + "-wrapper"
        });
        this.menu = this.wrapper.appendChild((0, $b26b082afa83b71a$export$2e2bcd8739ae039)("div", {
    ...
    updateFloat(scrollAncestor) {
        ...
        if (this.floating) {
            ...
            this.spacer = (0, $b26b082afa83b71a$export$2e2bcd8739ae039)("div", {
...
let $3dc44857371ec119$export$b8a1ef936d0e6c0c = new (0, $fc1204d3bb8e8da9$export$901cf72dabf2112a)({
    state: {
        init (_, { doc: doc  }) {
            return $3dc44857371ec119$var$lintDeco(doc);
        },
        apply (tr, old) {
            return tr.docChanged ? $3dc44857371ec119$var$lintDeco(tr.doc) : old;
        }
    },
    props: {
        decorations (state) {
        ...
        handleClick (view, _, event) {
            if (/lint-icon/.test(event.target.className)) {
                ...
                view.dispatch(view.state.tr.setSelection((0, $fc1204d3bb8e8da9$export$c2b25f346d19bcbb).create(view.state.doc, from, to)).scrollIntoView());
                return true;
            }
        },
...
function $3dc44857371ec119$var$lintDeco(doc) {
    let decos = [];
    $3dc44857371ec119$var$lint(doc).forEach((prob)=>{
        decos.push((0, $f18febfa986513b3$export$10e30b733df217ea).inline(prob.from, prob.to, {
            class: "problem"
        }), (0, $f18febfa986513b3$export$10e30b733df217ea).widget(prob.from, $3dc44857371ec119$var$lintIcon(prob)));
    });
    return (0, $f18febfa986513b3$export$93bf62eb445cec98).create(doc, decos);
}
function $3dc44857371ec119$var$lintIcon(prob) {
...
const $3dc44857371ec119$var$badWords = /\b(obviously|clearly|evidently|simply)\b/ig;
// Matches punctuation with a space before it
const $3dc44857371ec119$var$badPunc = / ([,\.!?:]) ?/g;
// Matches punctuation with a space before it
const $3dc44857371ec119$var$goToLinks = /->/ig;
function $3dc44857371ec119$var$lint(doc) {
    ...
    doc.descendants((node, pos)=>{
        if (node.isText) {
            ...
            let m;
            while(m = $3dc44857371ec119$var$goToLinks.exec(node.text))record(`GoTo '${m[0]}'`, pos + m.index, pos + m.index + m[0].length);
            while(m = $3dc44857371ec119$var$badWords.exec(node.text))record(`Try not to say '${m[0]}'`, pos + m.index, pos + m.index + m[0].length);
            while(m = $3dc44857371ec119$var$badPunc.exec(node.text))record("Suspicious spacing around punctuation", pos + m.index, pos + m.index + m[0].length, $3dc44857371ec119$var$fixPunc(m[1] + " "));
        } else if (node.type.name == "heading") {
            // Check whether heading levels fit under the current level
            let level = node.attrs.level;
            if (lastHeadLevel != null && level > lastHeadLevel + 1) record(`Heading too small (${level} under ${lastHeadLevel})`, pos + 1, pos + 1 + node.content.size, $3dc44857371ec119$var$fixHeader(lastHeadLevel + 1));
            lastHeadLevel = level;
        } else if (node.type.name == "image" && !node.attrs.alt) // Ensure images have alt text
        record("Image without alt text", pos, pos + 1, $3dc44857371ec119$var$addAlt);
    });
    return result;
}
function $3dc44857371ec119$var$fixPunc(replacement) {
...
function $3dc44857371ec119$var$fixHeader(level) {
    return function({ state: state , dispatch: dispatch  }) {
...
function $3dc44857371ec119$var$addAlt({ state: state , dispatch: dispatch  }) {
...
var $ce361cf3ec8002b9$var$toLint = [
    {
        regexExp: /=== .* ===/ig,
        classSuffix: "knot",
        quickStyle: {
...
function $ce361cf3ec8002b9$var$addCss(cssText) {
    var style = document.createElement("style");
    style.innerHTML = cssText;
    document.head.appendChild(style);
}
var $ce361cf3ec8002b9$export$766a155e493c5bee = function() {
    var cssToAdd = "";
    for(let i = 0; i < $ce361cf3ec8002b9$var$toLint.length; i++)if ($ce361cf3ec8002b9$var$toLint[i].quickStyle) {
        cssToAdd += ".prose_highlight_" + $ce361cf3ec8002b9$var$toLint[i].classSuffix + "{";
        if ($ce361cf3ec8002b9$var$toLint[i].quickStyle.bold) cssToAdd += "font-weight: bold;";
        if ($ce361cf3ec8002b9$var$toLint[i].quickStyle.italic) cssToAdd += "font-style: italic;";
        if ($ce361cf3ec8002b9$var$toLint[i].quickStyle.color) cssToAdd += "color:" + $ce361cf3ec8002b9$var$toLint[i].quickStyle.color + ";";
        cssToAdd += "}";
        $ce361cf3ec8002b9$var$addCss(cssToAdd);
    }
    function lintDeco(doc) {
        let decos = [];
        lint(doc).forEach((prob)=>{
            decos.push((0, $f18febfa986513b3$export$10e30b733df217ea).inline(prob.from, prob.to, {
                class: "prose_highlight_" + prob.classSuffix
            }), (0, $f18febfa986513b3$export$10e30b733df217ea).widget(prob.from, lintIcon(prob)));
        });
        return (0, $f18febfa986513b3$export$93bf62eb445cec98).create(doc, decos);
    }
    ...
    function lint(doc) {
        ...
        doc.descendants((node, pos)=>{
            if (node.isText) {
                // Scan text nodes for suspicious patterns
                let m;
                for(let i = 0; i < $ce361cf3ec8002b9$var$toLint.length; i++)while(m = $ce361cf3ec8002b9$var$toLint[i].regexExp.exec(node.text))record(`${$ce361cf3ec8002b9$var$toLint[i].classSuffix} '${m[0]}'`, pos + m.index, pos + m.index + m[0].length, $ce361cf3ec8002b9$var$toLint[i].classSuffix);
    ...
    function addAlt({ state: state , dispatch: dispatch  }) {
        let alt = prompt("Alt text", "");
        if (alt) {
            let attrs = Object.assign({}, state.doc.nodeAt(this.from).attrs, {
                alt: alt
    ...
    return new (0, $fc1204d3bb8e8da9$export$901cf72dabf2112a)({
        key: new (0, $fc1204d3bb8e8da9$export$1692d8b0e89cecc3)("customHighlighter"),
        state: {
            init (_, { doc: doc  }) {
                return lintDeco(doc);
            },
...
function $4e76ad1d525e6107$export$6be8a1d954707247(mentionTrigger, hashtagTrigger, allowSpace) {
...
function $4e76ad1d525e6107$export$26748ec468348572($position, opts) {
    ...
    var regex = $4e76ad1d525e6107$export$6be8a1d954707247(opts.mentionTrigger, opts.hashtagTrigger, opts.allowSpace);
...
const $4e76ad1d525e6107$export$61fc7d43ac8f84b0 = function() {
    var timeoutId = null;
...
var $4e76ad1d525e6107$var$getNewState = function() {
    return {
        active: false,
        range: {
            from: 0,
...
function $4e76ad1d525e6107$export$283bd57e93429c29(opts) {
    // default options
    var defaultOpts = {
        mentionTrigger: "@",
        hashtagTrigger: "#",
   ...
   */ return new (0, $fc1204d3bb8e8da9$export$901cf72dabf2112a)({
        key: new (0, $fc1204d3bb8e8da9$export$1692d8b0e89cecc3)("autosuggestions"),
        // we will need state to track if suggestion dropdown is currently active or not
        state: {
            init () {
                return $4e76ad1d525e6107$var$getNewState();
            },
            apply (tr, state) {
                // compute state.active for current transaction and return
                var newState = $4e76ad1d525e6107$var$getNewState();
                var selection = tr.selection;
                if (selection.from !== selection.to) return newState;
                const $position = selection.$from;
                const match = $4e76ad1d525e6107$export$26748ec468348572($position, opts);
        ...
        props: {
            handleKeyDown (view, e) {
                ...
                if (down) {
                    ...
                    hideList();
                    this.state = $4e76ad1d525e6107$var$getNewState();
                    return true;
            ...
            decorations (editorState) {
                ...
                return (0, $f18febfa986513b3$export$93bf62eb445cec98).create(editorState.doc, [
        ...
        view () {
            return {
                update: (view)=>{
                    ...
                    showListTimeoutId = $4e76ad1d525e6107$export$61fc7d43ac8f84b0(function() {
 ...
 */ const $0923459b3052f6ec$export$dbe73ad4b798c202 = {
    group: "inline",
    inline: true,
    atom: true,
    attrs: {
...
const $0923459b3052f6ec$export$c5923750b3608ed7 = {
    group: "inline",
    inline: true,
    atom: true,
    attrs: {
...
const $0923459b3052f6ec$export$a60ac68fb46161c9 = {
    group: "inline",
    inline: true,
    atom: true,
    attrs: {
...
function $c6f350a5636f5ef9$export$d1f78ce1d47a0eb9(nodes) {
    return nodes.append({
        mention: (0, $0923459b3052f6ec$export$dbe73ad4b798c202)
    });
}
function $c6f350a5636f5ef9$export$5adad8d72519ec85(nodes) {
    return nodes.append({
        tag: (0, $0923459b3052f6ec$export$c5923750b3608ed7)
    });
}
function $c6f350a5636f5ef9$export$de6371a67e6f66ab(nodes) {
    return nodes.append({
        arrow: (0, $0923459b3052f6ec$export$a60ac68fb46161c9)
    });
}
...
var $d832f2ef8a5ce6ac$var$createEditor = function({ initialJson: initialJson , initialDomValue: initialDomValue = "" , tagsCallbacks: tagsCallbacks = {
    ...
    var mySchema = new (0, $59526ec4d3b41406$export$19342e026b58ebb7)({
        nodes: (0, $c6f350a5636f5ef9$export$de6371a67e6f66ab)((0, $c6f350a5636f5ef9$export$5adad8d72519ec85)((0, $c6f350a5636f5ef9$export$d1f78ce1d47a0eb9)((0, $053d3e35c0447a93$export$fa2e7d3d1550c2ea)((0, $bdf1d61f73714893$export$4902baddc787debb).spec.nodes, "paragraph block*", "block")))),
        marks: (0, $bdf1d61f73714893$export$4902baddc787debb).spec.marks
    });
    //Mention
    /**
   * IMPORTANT: outer div's "suggestion-item-list" class is mandatory. The plugin uses this class for querying.
   * IMPORTANT: inner div's "suggestion-item" class is mandatory too for the same reasons
   */ var getMentionSuggestionsHTML = (items)=>'<div class="suggestion-item-list">' + items.map((i)=>'<div class="suggestion-item">' + i.name + "</div>").join("") + "</div>";
    /**
   * IMPORTANT: outer div's "suggestion-item-list" class is mandatory. The plugin uses this class for querying.
   * IMPORTANT: inner div's "suggestion-item" class is mandatory too for the same reasons
   */ var getTagSuggestionsHTML = (items)=>'<div class="suggestion-item-list">' + items.map((i)=>'<div class="suggestion-item">' + i.tag + "</div>").join("") + "</div>";
    var plugins = (0, $23cc8b60725a3082$export$a24aa9c6e8fd0231)({
        schema: mySchema
    }).concat((0, $3dc44857371ec119$export$b8a1ef936d0e6c0c)).concat((0, $ce361cf3ec8002b9$export$766a155e493c5bee)());
    ...
    const onEnter = (EditorState, dispatch, EditorView)=>{
        ...
        console.log(previousText[1]);
        if (previousText[searchIndex] == " ") while(previousText[searchIndex] == " "){
            searchIndex++;
            previousLineWhitespaces += " ";
        }
        //const blockType = EditorState.selection.$head.parent;
        (0, $7688feb235d1dd81$export$146a774cdef7663a)((0, $7688feb235d1dd81$export$a5d02b4b65e94f91), (0, $7688feb235d1dd81$export$d0f80ac1b4510888), (0, $7688feb235d1dd81$export$a3574cc681852c08), (0, $7688feb235d1dd81$export$e99155638ff4dff0))(EditorState, dispatch) //The default binding for Enter tries newlineInCode, createParagraphNear, liftEmptyBlock, splitBlock, in that order
        ;
        ...
        if (searchIndex > 0) {
            ...
            const { from: from , to: to  } = window.view.state.selection;
            const { tr: tr  } = window.view.state;
            // tr.setSelection()
    ...
    var customKM = (0, $1e062bab1b3a59ef$export$5043418e2ef368d5)({
        "Tab": insertTab
    });
    var customEnter = (0, $1e062bab1b3a59ef$export$5043418e2ef368d5)({
        "Enter": insertIndent
    });
    ...
    function findInNode(root, node, term) {
        ...
        } else node.content.forEach((child, i)=>ret = ret.concat(findInNode(root, child, findResult)));
        console.log(ret, ret);
        return ret;
    }
    var mentionPlugin = (0, $4e76ad1d525e6107$export$283bd57e93429c29)({
        ...
        getSuggestions: (type, text, done)=>{
            ...
            setTimeout(()=>{
                ...
                else done(tagsArrays["arrow"].filter((e)=>e.tag.toLowerCase().search(text.toLowerCase()) >= 0));
            }, 0);
        },
        getSuggestionsHTML: (items, type)=>{
            if (type === "mention") return getMentionSuggestionsHTML(items);
            else if (type === "tag") return getTagSuggestionsHTML(items);
            else if (type === "arrow") return getTagSuggestionsHTML(items);
        }
    });
...
var $d832f2ef8a5ce6ac$export$2e2bcd8739ae039 = $d832f2ef8a5ce6ac$var$createEditor;
