...
export function createStructureSettingsTable (projectId) {
    ...
    var cols = [
        // {title:"id", field:"uuid", },
        {customIcon:true, field:"iconPath", defaultPath:"folder.svg",callback:(e,cell)=>{ 
            iconSelect({
        ...
        {customButton: {value:"X", style:"smallCircle", onClick:function(e, cell){if(confirm("Delete?"))projectManagement.getProjectStore(projectId,"structures").remove(cell.getRow().getData().uuid)} } },
