...
var attributeAggregate = function(aggregate, projectStore){
...
var createAttributeManagement = function () {
    return createRepoManagement(projectManagement.getCurrent().id, 'properties', attributeAggregate)
}

export default createAttributeManagement