...
var simulationAggregate = function(aggregate, projectStore){
...
var createSimulationManagement = function () {
    return createRepoManagement(projectManagement.getCurrent().id, 'simulations', simulationAggregate)
}

export default createSimulationManagement