...
var cycleAggregate = function(aggregate, projectStore){
...
var createCyclesManagement = function () {
    return createRepoManagement(projectManagement.getCurrent().id, 'cycles', cycleAggregate)
}

export default createCyclesManagement